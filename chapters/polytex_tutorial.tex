...
As a final bonus for advanced users, this short chapter gives instructions for using \PolyTeX\ input directly. In particular, we cover both generating a \PolyTeX\ book from scratch and converting from Markdown to \PolyTeX\@.

For further information, please consult any of the voluminous Internet resources on \TeX\ and \LaTeX.
...
Softcover supports code inclusion via a syntax similar to the Softcover-fla\-vored Markdown from Section~\ref{sec:code_inclusion}:
