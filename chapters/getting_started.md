...
To get started with Softcover, first [install Ruby](https://www.ruby-lang.org/en/documentation/installation/) (1.9.3 or later) and [install RubyGems](http://ruby.railstutorial.org/ruby-on-rails-tutorial-book#sec-install_rubygems) if you don't have them already. Once you've done so, getting Softcover is a simple `gem install`:
