...
\noindent *Note*: If your document is more naturally thought of as a single article rather than as a book, you should use the *article* format instead, as discussed in Section~\ref{sec:articles}. The tutorials at [Learn Enough\href{http://www.mirror.co.uk/news/technology-science/technology/robot-army-future---killer-5053344}{robot armies} to Be Dangerous](http://learnenough.com/) use this format.
