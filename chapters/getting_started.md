...
- [EpubCheck 4.0](https://github.com/IDPF/epubcheck/releases/download/v4.0.1/epubcheck-4.0.1.zip)[^epub_check_version] (unzip and place in a diretory on your path, i.e., `$HOME/bin`[^epub_path])
