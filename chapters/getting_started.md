...
Softcover also supports the LaTeX *article* format, which produces an ebook that is effectively a single chapter. As mentioned above, the tutorials at [Learn Enough™ to Be Dangerous](http://learnenough.com/) use this format.
